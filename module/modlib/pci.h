...
static inline void
pci_register_intr_handler(struct PCIDevice *dev, void (*handler)(struct PCIDevice *)) {
...
static inline void
pci_msix_set_message(struct PCIDevice *pci_dev, unsigned int vec, const struct MSIMessage *msg) {
