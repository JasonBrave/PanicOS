...
static void pci_legacy_write_config_reg8(const struct PciAddress* addr, int reg,
										 uint8_t data) {
	outdw(PCI_IO_CONFADD, addr->bus << PCI_IO_CONF_BUSNUM |
							  addr->device << PCI_IO_CONF_DEVNUM |
							  addr->function << PCI_IO_CONF_FUNCNUM | (reg & 0xfc) |
...
static void pci_legacy_write_config_reg16(const struct PciAddress* addr, int reg,
										  uint16_t data) {
	outdw(PCI_IO_CONFADD, addr->bus << PCI_IO_CONF_BUSNUM |
							  addr->device << PCI_IO_CONF_DEVNUM |
							  addr->function << PCI_IO_CONF_FUNCNUM | (reg & 0xfc) |
...
static void pci_legacy_write_config_reg32(const struct PciAddress* addr, int reg,
										  uint32_t data) {
	outdw(PCI_IO_CONFADD, addr->bus << PCI_IO_CONF_BUSNUM |
							  addr->device << PCI_IO_CONF_DEVNUM |
							  addr->function << PCI_IO_CONF_FUNCNUM | (reg & 0xfc) |
